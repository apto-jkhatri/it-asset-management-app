...
import { Box, ShieldCheck, Loader2, ArrowRight } from 'lucide-react';
      ...
      <div className="max-w-md w-full relative z-10">
        <div className="bg-slate-800/50 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden border border-slate-700/50 p-8 pt-12">
          ...
          <div className="space-y-6">
            <div className="bg-slate-900/50 rounded-2xl p-6 border border-slate-700/30">
              <div className="flex items-center gap-4 text-slate-300 mb-6">
                ...
                <div className="text-sm">
                  <p className="font-semibold text-white">Single Sign-On</p>
              ...
              <button
                ...
                className="w-full bg-white hover:bg-slate-100 text-slate-900 font-bold py-4 rounded-xl transition-all flex items-center justify-center group disabled:opacity-60 shadow-xl shadow-white/5 active:scale-[0.98]"
              >
                {isAuthLoading ? (
            ...
            {error && (
              <div className="text-red-400 text-sm bg-red-950/30 p-4 rounded-xl border border-red-900/30 text-center animate-pulse">
                {error}
              </div>
            )}
          </div>
          ...
          <div className="mt-12 text-center">
             <div className="inline-flex items-center gap-2 px-3 py-1 bg-slate-900/50 rounded-full border border-slate-700/50">
               ...
               <span className="text-[10px] text-slate-500 uppercase tracking-widest font-bold">Secure Desktop Node v2.4</span>
             </div>
          </div>
        </div>
